...
public class BasicCoapClient implements CoapClient {
	...
	public BasicCoapClient(String serverAddress) throws UnknownHostException {
        ...
        channelManager = (BasicCoapChannelManager) BasicCoapChannelManager
                .getInstance();
            clientChannel = (BasicCoapClientChannel) channelManager.connect(
                    this, InetAddress.getByName(SERVER_ADDRESS), PORT);
            ...
            System.out.println("HIT : BasicCoapClient ");
	}
