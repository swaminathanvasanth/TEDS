 ...
 */
public class Description extends DataBlock{

    private String value;

    private Description(){
        super(DataBlock.DESCRIPTION);
        value = new String();
    }

    public Description(String val) throws Exception {
        this();
        value = val;
    }

    public Description(DataBlock db, UInt8[] args) throws Exception{
        this();
