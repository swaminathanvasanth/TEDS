 ...
 */
public class SPeriod extends DataBlock{

    private Float32 value;

    private SPeriod(){
        super(DataBlock.SPERIOD);
        value = new Float32();
    }

    public SPeriod(float val) throws Exception {
        this();
        value.setValue(val);
    }

    public SPeriod(DataBlock db, UInt8[] args) throws Exception{
        this();
