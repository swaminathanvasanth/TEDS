...
public class sequenceInWindowPatternQuery extends PatternQuery{
		...
		public sequenceInWindowPatternQuery(String in_query,LinkedHashMap<String,String> in_schemaVariables) throws differentTypesException
		{
			super(in_query);
			...
			String currentQuery=query.replace("pat{","").replace("}","");
