...
public class Toolbar extends Composite implements ILocaleListChangeListener{
	...
	private Label click = new Label(" Click ");
	private Label to = new Label(" To ");
	private Label load = new Label(" Load ");
	...
	private void setupToolbar(){
		...
		*/
		...
		Label label = new Label("-- TEDS Creator --");
		panel.add(label);
	...
	private void setupClickListeners(){
		...
		btnOpenForm.addClickHandler(new ClickHandler(){
			public void onClick(ClickEvent event){
				...
				controller.openForm();
				FormUtil.dlg.hide();
				Window.alert("----Form Loaded----\nTo view the form \n  1) Open Preview Tab. \n  2) Right click, refresh \n ");}
				
				else {
					FormUtil.dlg.hide();
					Window.alert("Form already Loaded");
				}
